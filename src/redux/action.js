...
export const getTodo = () => async (dispatch) => {
  try {
     ...
     const {data} = await axios.get("https://json-server-mocker-masai.herokuapp.com/tasks")
...
export const addTodo = (payload) =>  async (dispatch) => {
  try {
    ...
    const data = await axios.post("https://json-server-mocker-masai.herokuapp.com/tasks",payload)
...
export const deleteTodo = (payload) => async (dispatch) => {
  try {
     ...
     const data = await axios.delete(`https://json-server-mocker-masai.herokuapp.com/tasks/${payload}`)
...
export const toggleTodo = (payload) => async (dispatch) => {
  try {
   ...
   const {data: itemData} = await axios.get(`https://json-server-mocker-masai.herokuapp.com/tasks/${payload}`)
   //console.log(itemData, "itemdata")
   
   const data = await axios.put(`https://json-server-mocker-masai.herokuapp.com/tasks/${payload}`, {...itemData, status: !itemData.status})
